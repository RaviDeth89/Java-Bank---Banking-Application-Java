...
<html>
    ...
    <body>  
        ...
        <div class="container1">
            <form action="Money_Transfer_01.jsp" style="border:1px solid #ccc" method="post">
                <div class="container">
                    <h1 align="center">Quick Money Transfer </h1>
                        <hr>
                  ...
                  background: #f1f1f1;">
                    ...
                    <label for="ts_account_no"><b>Transfer to Account number</b></label>
                    <input type="text" placeholder="Beneficiary Account number (min 10 digit)" name="ts_account_no" required/>
                    
                    <label for="ts_amount"><b>Amount (Rs.)</b></label>
                    <input type="text" placeholder="Amount" name="ts_amount" required/>
