			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
                    ...
                    <div class="c_d_time">
                        ...
                        <c:set var="ac_number1" scope="session" value="${param.account_no}"></c:set>
                        ...
                        <c:forEach items="${rs.rows}" var="row">     
                            ...
                            <%--<c:set var="x19" value="${row.password}"></c:set>--%>
                            <c:set var="x20" value="${row.status}"></c:set>
                            <c:set var="x21" value="${row.id_no}"></c:set>
                        </c:forEach>
                        <div>
                            <form action="Admin_004.jsp" method="post" align="left">
                                <label>Account Status:</label>
                                <select name="status" style="border-color: green;">
                                <option value="Inactive" style="border-color: green;">Inactive</option>
                                <option value="Active" style="border-color: green;">Active</option>
                                </select>
                                <button class="btn" type="submit" style="border-color: black;">Update Status</button>
                            </form>
                            <br>
                            <form action="Admin_005.jsp" method="post" align="left">
                                Balance : <input type="text" name="bal" placeholder="Amount (Rs.)"  style="border-color: green;"/>
                                 <button class="btn" type="submit" style="border-color: black;">Update Balance</button>
                            </form>
                        </div>
