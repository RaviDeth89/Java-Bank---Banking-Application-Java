    ...
    <body>  
            ...
            <c:choose>
                <c:when test="${x4==x5}">
                    <c:choose>    
                        <c:when test="${param.account_no==x1 && param.password==x3}">
                            <c:set var="ac_number" value="${param.account_no}" scope="session"></c:set>
                        ...
                        <c:otherwise>
                            ...
                            <% 
                                ...
                                out.println("location='Net_Banking_Login.jsp';");
                                out.println("</script>");
                                RequestDispatcher rd2=request.getRequestDispatcher("/Net_Banking_Login.jsp");
                ...
                <c:otherwise>
                     <% 
                        out.println("<script type=\"text/javascript\">");
                        out.println("alert('Your account is Inactive !! Contact to your bank manager.');");
                        out.println("location='Net_Banking_Login.jsp';");
                        out.println("</script>");
                        RequestDispatcher rd1=request.getRequestDispatcher("/Net_Banking_Login.jsp");
